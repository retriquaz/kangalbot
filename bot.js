...
var akbaş = fs.readFileSync('./akbaş.txt', 'utf8');
var alabay = fs.readFileSync('./alabay.txt', 'utf8');
var açk = fs.readFileSync('./açk.txt', 'utf8');
var bulldog = fs.readFileSync('./bulldog.txt', 'utf8');
var chihuahua = fs.readFileSync('./chihuahua.txt', 'utf8');
var doberman = fs.readFileSync('./doberman.txt', 'utf8');
var golden = fs.readFileSync('./golden.txt', 'utf8');
var haski = fs.readFileSync('./haski.txt', 'utf8');
var kçk = fs.readFileSync('./kçk.txt', 'utf8');
var kangal = fs.readFileSync('./kangal.txt', 'utf8');
var komondor = fs.readFileSync('./komondor.txt', 'utf8');
var labrador = fs.readFileSync('./labrador.txt', 'utf8');
var malaklı = fs.readFileSync('./malaklı.txt', 'utf8');
var pom = fs.readFileSync('./pom.txt', 'utf8');
var pug = fs.readFileSync('./pug.txt', 'utf8');
var rottweiler = fs.readFileSync('./rottweiler.txt', 'utf8');
var shiba = fs.readFileSync('./shiba.txt', 'utf8');
var shihtzu = fs.readFileSync('./shih-tzu.txt', 'utf8')
