...
module.exports = (bot, message) => {
  ...
  const retri = ['göktuğ','göttuğ','retri','retriquaz'];
  {////////////////////////////////Random cevap/////////////////////////////////
 ...
 ////////////////////////////////Cevaplar///////////////////////////////////////
  ...
  if (retri.includes(message.content.toLowerCase())) {
    message.reply({content:"<@288316237535248385> = Göbeğinden siki kaybolmuş mitolojik HolySexBear.", files: [{attachment: "https://i.hizliresim.com/btd43qo.jpg"}]})
  }//Retri
  
  if(message.content.toLowerCase() === 'slayerblue'){
     message.reply({ content: "<@361552512165347329> = Amına koduğumun ruh hastası.",
   files: ["https://i.hizliresim.com/1en2s9w.jpg"]
 })
   }//slayerblue

  if(message.content.toLowerCase() === 'melis'){
     message.reply({ content: "<@408993141686009866> = Ödemişin ilk gay atkivisti.",
   ...
   if(message.content.toLowerCase() === 'seymen'){
	   message.reply("<@575769177948684288> = Amua goduuumun pedo piçi")
   }//seymen

   // if(message.content.toLowerCase() === 'ramiqk'){
	 //   message.reply("<@689556061673226292> = Amına kodumun orospu çocuuu")
   // }//ramiqk
